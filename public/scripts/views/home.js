...
const homeTemplate = () => context.html`
        <section id="home">
            ...
            <div class="home-info">
                ...
                <a href="/posts#development"><button class="home-btn interactable">View More</button></a>
            </div>
            <div class="home-info">
                <h1>Blockchain</h1>
                ...
                <a href="/posts#blockchain"><button class="home-btn interactable">View More</button></a>
            </div>
            ...
            <div class="home-info">
                ...
                <a href="/posts#artificial-intelligence"><button class="home-btn interactable">View More</button></a>
            </div>
        </section>
`;
...
export function homePage(ctx) {
    context = ctx;
    context.render(homeTemplate(), context.main);
}